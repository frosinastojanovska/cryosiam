...
from cryosiam.apps.simsiam_prediction.cluster_oriented_particles import run as cluster_oriented_particles_main
from cryosiam.apps.prototype_refinement.cluster_subtomograms_simsiam import run as cluster_subtomograms_simsiam_main
...
def main():
    ...
    # cluster oriented particles using SimSiam embeddings
    sp_simsiam = subparsers.add_parser("simsiam_cluster_oriented_particles",
                                       help="Cluster oriented particles using SimSiam embeddings")
    sp_simsiam.add_argument('--config_file', type=str, required=True,
                            help='Path to the .yaml configuration file')
    sp_simsiam.set_defaults(func=lambda args: cluster_oriented_particles_main(args.config_file))
